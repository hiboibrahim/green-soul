...
const OurProjects = () => {
  return (
    <>
    <div className="our-project main justify-content-center align-items-center mt-4 pt-5 pb-1 p-5">
      <h3 className="text-center">Nourishing Communities and Building Connections</h3>
