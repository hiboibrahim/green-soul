...
const OurProjects = () => {
  return (
    ...
    <div className="our-project main justify-content-center align-items-center mt-4 pt-4 pb-1 pe-5 ps-5">
      ...
      <h3 className="lh-3 pt-2 about-p">At the heart of our mission is a commitment to fostering well-being and community through thoughtful, impactful projects. Our initiatives are designed to address various aspects of food security and community cohesion, ensuring that everyone has access to nutritious food and a supportive network. Building ttronger communities, one meal at a time.</h3>
